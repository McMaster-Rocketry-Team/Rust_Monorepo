...
async fn main() -> Result<()> {
    ...
    match args.mode {
        ...
        ModeSelect::ListFiles => usb_storage::list_files(),
        ModeSelect::DownloadFile(args) => usb_storage::download_file(&args.filename),
        ModeSelect::ClearStorage => usb_storage::clear_storage(),
    }
}
