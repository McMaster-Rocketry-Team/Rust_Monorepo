...
fn downlink_json(packet: &VLPDownlinkPacket, status: &PacketStatus) -> Value {
    match packet {
        VLPDownlinkPacket::Telemetry(p) => json!({
            ...
            "drogue_deployed": p.drogue_deployed(),
            "main_deployed": p.main_deployed(),
            ...
            "ab_vote_inertial": p.ab_vote_inertial(),
            "ab_vote_deployment": p.ab_vote_deployment(),
            "ab_vote_baro_rate": p.ab_vote_baro_rate(),
            "ab_born": p.ab_born(),
