...
impl RocketStateMessage {
    pub fn new(timestamp_us: u64, velocity: &[f32; 2], altitude_agl: f32) -> Self {
        Self {
...
mod test {
    ...
    fn create_test_messages() -> Vec<CanBusMessageEnum> {
        vec![
            RocketStateMessage::new(0, &[0.0; 2], 0.0).into(),
            RocketStateMessage::new(0x00FFFFFFFFFFFFFF, &[f32::MAX; 2], f32::MAX).into(),
        ]
    }
